...
import 'package:crm_software/screen/allfresh_enquiry.dart';
import 'package:crm_software/screen/freshdeleted_lead.dart';
import 'package:crm_software/screen/freshnm_enquiry.dart';
import 'package:crm_software/screen/freshqualified_lead.dart';
...
class FreshEnquiryPage extends StatefulWidget {
  final tabIndex;
  const FreshEnquiryPage({Key? key, this.tabIndex}) : super(key: key);

  @override
  State<FreshEnquiryPage> createState() => _FreshEnquiryPageState();
}

class _FreshEnquiryPageState extends State<FreshEnquiryPage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String tabcount2 = '0';
  String tabcount3 = '0';
  String tabcount4 = '0';
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  ...
                  Tab(child: Text('All Fresh (${tabcount5})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/freshleadcount.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/freshleadcount.php';
