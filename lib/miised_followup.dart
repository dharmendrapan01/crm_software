...
import 'package:crm_software/screen/missedfoloup_lead.dart';
...
class MissedFollowup extends StatefulWidget {
  const MissedFollowup({Key? key}) : super(key: key);

  @override
  State<MissedFollowup> createState() => _MissedFollowupState();
}

class _MissedFollowupState extends State<MissedFollowup> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String? userToken = '';
  String? userId = '';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('Missed Followup (${tabcount1})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/missedfolwupcount.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/missedfolwupcount.php';
