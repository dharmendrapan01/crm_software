...
import 'package:crm_software/screen/qualdelete_enq.dart';
...
class QualifiedDeletePage extends StatefulWidget {
  const QualifiedDeletePage({Key? key}) : super(key: key);

  @override
  State<QualifiedDeletePage> createState() => _QualifiedDeletePageState();
}

class _QualifiedDeletePageState extends State<QualifiedDeletePage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String? userToken = '';
  String? userId = '';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('Qualified Delete (${tabcount1})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/qualdelete_count.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/qualdelete_count.php';
