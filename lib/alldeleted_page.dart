...
import 'package:crm_software/screen/alldeleted_enq.dart';
import 'package:crm_software/screen/freshdeleted_lead.dart';
import 'package:crm_software/screen/menue_page.dart';
import 'package:crm_software/screen/nqdelete_enq.dart';
import 'package:crm_software/screen/spamdelete_enq.dart';
...
class AllDeletedPage extends StatefulWidget {
  final tabIndex;
  const AllDeletedPage({Key? key, this.tabIndex}) : super(key: key);

  @override
  State<AllDeletedPage> createState() => _AllDeletedPageState();
}

class _AllDeletedPageState extends State<AllDeletedPage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String tabcount2 = '0';
  String tabcount3 = '0';
  String tabcount4 = '0';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('All Deleted (${tabcount1})', style: TextStyle(color: Colors.black),),),
                  Tab(child: Text('Fresh Deleted (${tabcount2})', style: TextStyle(color: Colors.black),),),
                  Tab(child: Text('Not Qualify Deleted (${tabcount3})', style: TextStyle(color: Colors.black),),),
                  Tab(child: Text('Spam Deleted (${tabcount4})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/deleted_count.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/deleted_count.php';
