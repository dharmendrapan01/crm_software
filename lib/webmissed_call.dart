...
class WebMissedCall extends StatefulWidget {
  ...
  @override
  State<WebMissedCall> createState() => _WebMissedCallState();
}

class _WebMissedCallState extends State<WebMissedCall> {
  ...
  Future getData(userToken, userId, paraPage) async {
    ...
    var apiUrl = '$apiRootUrl/webmissed_call.php';
      ...
      body: Container(
        ...
        child: result.isEmpty ? Center(child: CircularProgressIndicator()) : RefreshIndicator(
          onRefresh: () {
            ...
            Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (BuildContext context) => HomePage(tabIndex: 4,)), (Route<dynamic> route) => false);
