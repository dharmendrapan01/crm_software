...
class NotQualDeletePage extends StatefulWidget {
  const NotQualDeletePage({Key? key}) : super(key: key);

  @override
  State<NotQualDeletePage> createState() => _NotQualDeletePageState();
}

class _NotQualDeletePageState extends State<NotQualDeletePage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String? userToken = '';
  String? userId = '';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('Not Qualified Delete (${tabcount1})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/nqdelete_count.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/nqdelete_count.php';
