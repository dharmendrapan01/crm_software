...
import 'package:crm_software/screen/alldata_enq.dart';
import 'package:crm_software/screen/datadeleted_enq.dart';
import 'package:crm_software/screen/datanm_enquiry.dart';
import 'package:crm_software/screen/dataqualified_enq.dart';
...
class DataEnquiryPage extends StatefulWidget {
  final tabIndex;
  const DataEnquiryPage({Key? key, this.tabIndex}) : super(key: key);

  @override
  State<DataEnquiryPage> createState() => _DataEnquiryPageState();
}

class _DataEnquiryPageState extends State<DataEnquiryPage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String tabcount2 = '0';
  String tabcount3 = '0';
  String tabcount4 = '0';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('Not Modified (${tabcount1})', style: TextStyle(color: Colors.black),),),
                  ...
                  Tab(child: Text('All Data Enq (${tabcount5})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/dataenqcount.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/dataenqcount.php';
