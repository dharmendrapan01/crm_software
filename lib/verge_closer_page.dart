...
import 'package:crm_software/screen/vergecloser_enq.dart';
...
class VergeCloserPage extends StatefulWidget {
  const VergeCloserPage({Key? key}) : super(key: key);

  @override
  State<VergeCloserPage> createState() => _VergeCloserPageState();
}

class _VergeCloserPageState extends State<VergeCloserPage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String? userToken = '';
  String? userId = '';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('On Verge On Sale (${tabcount1})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/vergeclosercount.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/vergeclosercount.php';
