...
class VoiceCallPlan extends StatefulWidget {
  final leadId;
  const VoiceCallPlan({Key? key, this.leadId}) : super(key: key);

  @override
  State<VoiceCallPlan> createState() => _VoiceCallPlanState();
}

class _VoiceCallPlanState extends State<VoiceCallPlan> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      _isButtonDisabled ? null : voiceCallPlan(userToken, userId, widget.leadId);
  ...
  Future<void> voiceCallPlan(userToken, userId, leadId) async {
    setState(() {
