...
class OldQualifyEnq extends StatefulWidget {
  const OldQualifyEnq({Key? key}) : super(key: key);

  @override
  State<OldQualifyEnq> createState() => _OldQualifyEnqState();
}

class _OldQualifyEnqState extends State<OldQualifyEnq> {
  List<Enqlist> result = [];
