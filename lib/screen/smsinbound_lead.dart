...
class SmsinboundLead extends StatefulWidget {
  final searchDate;
  const SmsinboundLead({Key? key, this.searchDate}) : super(key: key);

  @override
  State<SmsinboundLead> createState() => _SmsinboundLeadState();
}

class _SmsinboundLeadState extends State<SmsinboundLead> {
  ...
  void initState() {
    ...
    getSmsInboundData(userToken, userId, page, searchdateval.text);
