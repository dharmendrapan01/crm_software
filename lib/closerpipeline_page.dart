...
import 'package:crm_software/screen/closurepipeline_enq.dart';
...
class CloserPipeLinePage extends StatefulWidget {
  const CloserPipeLinePage({Key? key}) : super(key: key);

  @override
  State<CloserPipeLinePage> createState() => _CloserPipeLinePageState();
}

class _CloserPipeLinePageState extends State<CloserPipeLinePage> with TickerProviderStateMixin {
  String tabcount1 = '0';
  String? userToken = '';
  String? userId = '';
          ...
          Card(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(child: Text('Closure Pipeline (${tabcount1})', style: TextStyle(color: Colors.black),),),
                ],
              ),
            ),
          ),
  ...
  //       Uri.parse(
  //           '$apiRootUrl/closurepiplinecount.php?user_id=$userId'),
  //       headers: headersData);
  ...
  Future getCountVal(userToken, userId) async {
    ...
    var apiUrl = '$apiRootUrl/closurepiplinecount.php';
